...
function goTown() {
  //after clickigng this button we will redirect to home page
  update(locations[0]); //calling update function with bracket notation
}
function goStore() {
  update(locations[1]);
}
...
// initialize buttons.
button1.onclick = goStore; //buttons start working from here
